	...
	public class SysTryIcon : FrameworkElement
	{
		...
		private void CreateContextMenu()
		{
			...
			toolStripMenuItem2.Click += delegate(object sender, EventArgs e)
			{
				...
				if ((toolStripMenuItem6 = sender as ToolStripMenuItem) != null)
				{
					string text = toolStripMenuItem6.Text;
					if (text == "Show Always")
					{
						toolStripMenuItem6.Text = "Hide Automatically";
					...
					toolStripMenuItem6.Text = "Show Always";
			...
			ToolStripMenuItem toolStripMenuItem5 = new ToolStripMenuItem("Show Debug Window");
			toolStripMenuItem5.Click += delegate(object sender, EventArgs e)
			{
				if (this._debugWindow == null)
				{
					this._debugWindow = new DebugPlayWindow();
					this._debugWindow.Closed += delegate(object _s, EventArgs _e)
					{
			...
			this._notifyIcon.ContextMenuStrip.Items.Add(toolStripMenuItem5);
		...
		private DebugPlayWindow _debugWindow;
	}
}
